...
# Audio
$(call inherit-product, vendor/candy/audio/audio.mk)
...
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(CANDY_BUILD)/$(TARGET_PRODUCT).mk),product_manifest.xml rild Calendar Launcher3 Launcher3Go Launcher3QuickStep Launcher3QuickStepGo android.hidl.memory@1.0-impl.vendor vndk_apex_snapshot_package)
endif
...
PRODUCT_COPY_FILES += \
    vendor/candy/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
